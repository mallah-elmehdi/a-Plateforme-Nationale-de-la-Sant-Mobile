$(document).ready(function () {
	...
	function pdf() {
		...
		function generateMulPdf(region, province, trimestre, year) {
			...
			doc.text('Trimester : ' + $('#data').data('trimestre'), 15, 72);
			// ADD ALL TABLES
		...
		<div class="modal-dialog modal-fullscreen">
			<div class="modal-content">
				...
				<div class="modal-body bg-body">
					<div class="row g-3">
						<div class="col-12">
							<button type="button" class="btn btn-sm btn-light"  id="downloadRapportAllPdf" data-header='Rapport de suivi des activités de l’équipe mobile' data-region='${region}'>
