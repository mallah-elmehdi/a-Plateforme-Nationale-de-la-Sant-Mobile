$(document).ready(function () {
	...
	function ressourceData(ressource) {
		...
		if (out === '') {
			out = '<tr><td>Aucune</td><td>Aucune</td><td>Aucune</td><td>Aucune</td><td>0</td><td>0</td><td>0</td><td>0</td><td>Aucune</td></tr>'
		}
		return out;
	}
	// obj size
	...
	function pdrData(pdr) {
		...
		if (out === '') {
			out = '<tr><td>Aucune</td><td>Aucune</td><td>Aucune</td><td>Aucune</td><td>0</td><td>Aucune</td><td>Aucune</td></tr>'
		}
		return out;
	}
	// ADD PDR
	function programmeData(programme) {
		...
		if (out === '') {
			out = '<tr><td>Aucune</td><td>Aucune</td><td>Aucune</td><td>0</td><td>0</td><td>0</td><td>0</td></tr>'
		}
		return out;
	}
	// SHOW TABLE
	function showModal(code) {
		...
		title = "Plan d'action de la région " + reg;
			...
			<div class="modal-dialog modal-fullscreen">
				<div class="modal-content">
					...
					<div class="modal-body bg-body">
						<div class="row g-3">
							<div class="col-12">
								<button type="button" class="btn btn-sm btn-light downloadPdf"  data-header='Plan d’action de santé mobile' data-region='${reg}'>
