$(document).ready(function () {
	...
	function pdf() {
		...
		function generateMulPdf(region, province, year) {
			...
			doc.save(
				"plan d'action des unités médicales mobiles (umm) - " + region + ' - ' + 
					year +
					'.pdf'
			);
		}
					...
					<div class="modal-dialog modal-fullscreen">
						<div class="modal-content">
							<div class="modal-header border-0 p-2 bg-5">
								<span class="modal-title text-white fw-bold fs-7" id="modalTableLabel">Plan d’action des unités médicales mobiles (UMM) de la région ${regionElement}</span>
							...
							<div class="modal-body bg-body">
								<div class="row g-3">
									<div class="col-12">
										<button type="button" class="btn btn-sm btn-light" id="downloadPlanActionAllPdf" data-region="${regionElement}">
