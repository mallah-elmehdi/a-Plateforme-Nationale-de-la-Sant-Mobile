$(document).ready(function () {
	...
	function pdf() {
		...
		function generateMulPdf(region, year) {
			// VARIABLES
			var listTable = [];
			// GET ALL TABLES
			...
			doc.text('Trimester : ' + $('#dataRegion').data('trimestre'), 15, 72);
			// ADD ALL TABLES
	...
	function showModal(code) {
		...
		for (let i = 0; i < region.length; i++) {
			...
			if (element.codeRegion == code)
				regionElement = element.region
		}
		var title =
			'Rapport des activités des Unités Médical Mobile (UMM) de la région ' + regionElement
		...
		<div class="modal-dialog modal-fullscreen">
			<div class="modal-content">
				...
				<div class="modal-body bg-body">
					<div class="row g-3">
						<div class="col-12">
							<button type="button" class="btn btn-sm btn-light"  id="downloadRapportAllPdf" data-header='Rapport de suivi des activités de l’équipe mobile' data-region='${regionElement}'>
