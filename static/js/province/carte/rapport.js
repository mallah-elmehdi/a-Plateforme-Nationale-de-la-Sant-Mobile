			...
			<div class="modal-dialog modal-fullscreen">
				<div class="modal-content">
					...
					<div class="modal-body bg-body">
						<div class="row g-3">
							<div class="col-12">
								<button type="button" class="btn btn-sm btn-light"  id="downloadRapportAllPdf" data-header='Rapport de suivi des activités de l’équipe mobile' data-region='${region}' data-province='${province}'>
										...
										<div class="table-responsive">
											<table class="table thisTable table-bordered" id="santeMaternelle" data-title="Santé maternelle" data-id="santeMaternelle" data-align="left">
												<tbody>
													...
													<tr>
														<th rowspan="6" style="vertical-align: middle;">CPN</th>
