$(document).ready(function () {
	...
	$('#province-map').vectorMap({
		...
		onRegionClick: function (e, code) {
			if (code == codeProvince) showModal(code);
			else showErrorModal();
		},
	});
	...
	function showModal(code) {
		var title = "Plan d'action de la province " + province;
			...
			<div class="modal-dialog modal-fullscreen">
				<div class="modal-content">
					...
					<div class="modal-body bg-body">
						<div class="row g-3">
							<div class="col-12">
								<button type="button" class="btn btn-sm btn-light downloadPdf"  data-header='Rapport de suivi des activités de l’équipe mobile' data-region='${region}' data-province='${province}'>
