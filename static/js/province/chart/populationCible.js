$(document).ready(function () {
	...
	var wholeData = $('#data').data('provincedata'),
		...
		// init data
		// DATA LOADING
		data = getData([wholeData.populationCible], csrList);
	// CHART OPTION
	var options = {
		series: [
			{
	...
	$('input[type=radio][name=data]').change(function () {
		...
		if (this.value === 'populationCible') {
			...
			data = getData(
				[
					wholeData.enfantNaissancesAttendues,
					wholeData.enfantMoins1ans,
					wholeData.enfantMoins5ans,
				],
				csrList
			);
